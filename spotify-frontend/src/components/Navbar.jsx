    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='bg-black  text-[15px] px-4 py-1 rounded-full cursor-pointer '>Install App</p>
                <p className='bg-purple-500 text-black w-7 h-7  text-[15px] rounded-full flex items-center justify-center '>A</p>
            </div>
        </div>
